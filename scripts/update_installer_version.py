...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=CPNewPlugin Demo Installer\n"
      else:
        line="OutputBaseFilename=CPNewPlugin Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the CPNewPlugin Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the CPNewPlugin installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=CPNewPlugin Demo installer\n"
     else:
       line="SetupWindowTitle=CPNewPlugin installer\n"
