...
def main():
  ...
  plistpath = scriptpath + "/resources/CPNewPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CPNewPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CPNewPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CPNewPlugin-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CPNewPlugin-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/CPNewPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/CPNewPlugin.iss",inplace=1):
